...
\begin{tcolorbox}[enhanced jigsaw, breakable, colframe=quarto-callout-warning-color-frame, rightrule=.15mm, arc=.35mm, bottomrule=.15mm, colback=white, toprule=.15mm, left=2mm, leftrule=.75mm, opacityback=0]
...
climb up and over rocks, stopping only splash in creeks. At the end, you
have a picnic on the grass on a perfect, mild but warm day, without a
bug to be found.
...
even leave from home. We've been there.

However, we've also grown as a family who hikes, honed in on the
process, and adjusted our expectations. And sometimes the weather is
just right, we and the kiddos are having a great time, and, every once
in a while, there really isn't a bug in sight.
...
sealed the deal: hiking helped us to feel connected and later to love
where we live.
...
When taking on a lengthier hike or traveling farther from home, the
...
\item
  A jacket or additional layers for warmth
\item
  A towel
\item
  Shoes with some traction (though what are strictly called hiking shoes
  are not needed)
\item
  A first aid kit
\end{itemize}
...
\begin{tcolorbox}[enhanced jigsaw, breakable, colframe=quarto-callout-note-color-frame, rightrule=.15mm, arc=.35mm, bottomrule=.15mm, colback=white, toprule=.15mm, left=2mm, leftrule=.75mm, opacityback=0]
\begin{minipage}[t]{5.5mm}
...
\chapter{Trail 12: House Mountain State Natural
Area}\label{trail-12-house-mountain-state-natural-area}

\subsection{Overview}\label{overview-11}

This hike is not for the faint of heart, as the elevation gain is
significant! If you have littles that need to be carried, we recommend
waiting to tackle this hike (Katie carried our oldest in a baby carrier
up this hike when he was a baby and will honestly tell you she doesn't
have fond memories of this hike). This one always challenges us! But,
the flip side is that House Mountain offers a challenging hike to a
...
\chapter{Trail 13: Emory Falls at Frozen Head State
Park}\label{trail-13-emory-falls-at-frozen-head-state-park}
...
Has the largest simple leaf (a leaf with one piece) of any tree in North
America. In the fall, the leaves look like pages of newspapers scattered
on the ground! Common in the Cumberland Plateau (but not in the
Smokies).
...
\chapter{Trail 16: Fall Branch Falls Trail at Big South Fork National
River and Recreation
Area}\label{trail-16-fall-branch-falls-trail-at-big-south-fork-national-river-and-recreation-area}
...
\chapter{Trail 17: Twin Arches Trail at the Big South Fork National
River and Recreation
Area}\label{trail-17-twin-arches-trail-at-the-big-south-fork-national-river-and-recreation-area}
...
\chapter{Trail 18: Angel Falls Trail at Big South Fork National River
and Recreation
Area}\label{trail-18-angel-falls-trail-at-big-south-fork-national-river-and-recreation-area}
...
We can't make this hike up! This trail features rope ladders, wooden
ladders, gigantic sandstone walls, a scenic overlook, a trail that
traverses \emph{up} a river, and boulders you crawl over and through.
It's spectacular and challenging. This is a memorable trail that
exemplifies what makes the Cumberland Plateau region such a worthy
complement to the Great Smoky Mountains National Park. Younger children
may be able to hike the first half (traveling counterclockwise from the
trailhead); you can walk the road back to the trailhead. The second half
of the trail contains more challenging (but very beautiful) sections.
Still, it's hard -- probably the most difficult for most in this book,
making it best for the older kiddo hiker. Oh, and you will definitely
want to be prepared to get your feet wet on this hike!
...
\chapter{Trail 20: Spruce Flats Falls in Smoky Mountain National
Park}\label{trail-20-spruce-flats-falls-in-smoky-mountain-national-park}
...
\begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-note-color-frame, titlerule=0mm, breakable, opacitybacktitle=0.6, arc=.35mm, bottomtitle=1mm, leftrule=.75mm, toptitle=1mm, rightrule=.15mm, bottomrule=.15mm, toprule=.15mm, title={Note}, colback=white, left=2mm, colbacktitle=quarto-callout-note-color!10!white, opacityback=0, coltitle=black]
...
Backcountry sites in the Smokies: - Backcounty site \#1 - Backcountry
site \#17 - Backcountry site \#18

Shelters in the Smokies: - Shelters: Kephart Shelter, Icewater Springs
Shelter
...
The \emph{Tennessee Conservationist} is a nice magazine for the
