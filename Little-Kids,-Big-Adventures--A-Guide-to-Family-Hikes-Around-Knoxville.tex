...
\begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-warning-color-frame, toprule=.15mm, leftrule=.75mm, rightrule=.15mm, colback=white, opacityback=0, breakable, arc=.35mm, bottomrule=.15mm, left=2mm]
...
\begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-note-color-frame, bottomtitle=1mm, rightrule=.15mm, colback=white, title={Note}, breakable, left=2mm, coltitle=black, toprule=.15mm, leftrule=.75mm, toptitle=1mm, opacitybacktitle=0.6, opacityback=0, colbacktitle=quarto-callout-note-color!10!white, titlerule=0mm, arc=.35mm, bottomrule=.15mm]
