...
\begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-warning-color-frame, breakable, colback=white, bottomrule=.15mm, left=2mm, arc=.35mm, rightrule=.15mm, toprule=.15mm, opacityback=0, leftrule=.75mm]
...
\begin{tcolorbox}[enhanced jigsaw, rightrule=.15mm, breakable, colback=white, bottomrule=.15mm, toprule=.15mm, bottomtitle=1mm, colframe=quarto-callout-note-color-frame, leftrule=.75mm, colbacktitle=quarto-callout-note-color!10!white, title={Note}, toptitle=1mm, arc=.35mm, left=2mm, opacitybacktitle=0.6, titlerule=0mm, opacityback=0, coltitle=black]
