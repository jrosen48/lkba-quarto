...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, colback=white, breakable, opacityback=0, arc=.35mm, rightrule=.15mm, leftrule=.75mm, toprule=.15mm, colframe=quarto-callout-warning-color-frame, bottomrule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, breakable, opacityback=0, coltitle=black, bottomtitle=1mm, colframe=quarto-callout-note-color-frame, bottomrule=.15mm, left=2mm, colbacktitle=quarto-callout-note-color!10!white, colback=white, opacitybacktitle=0.6, toprule=.15mm, title={Note}, rightrule=.15mm, titlerule=0mm, leftrule=.75mm, toptitle=1mm, arc=.35mm]
