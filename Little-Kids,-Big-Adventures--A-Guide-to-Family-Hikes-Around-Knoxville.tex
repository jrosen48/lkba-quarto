...
\begin{tcolorbox}[enhanced jigsaw, opacityback=0, colframe=quarto-callout-warning-color-frame, colback=white, rightrule=.15mm, breakable, left=2mm, arc=.35mm, leftrule=.75mm, toprule=.15mm, bottomrule=.15mm]
...
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\linewidth - 18\tabcolsep) * \real{0.0369}}
  >{\raggedright\arraybackslash}p{(\linewidth - 18\tabcolsep) * \real{0.1181}}
  >{\raggedright\arraybackslash}p{(\linewidth - 18\tabcolsep) * \real{0.0923}}
  >{\raggedright\arraybackslash}p{(\linewidth - 18\tabcolsep) * \real{0.0738}}
  >{\raggedright\arraybackslash}p{(\linewidth - 18\tabcolsep) * \real{0.0554}}
  >{\raggedright\arraybackslash}p{(\linewidth - 18\tabcolsep) * \real{0.0664}}
  >{\raggedright\arraybackslash}p{(\linewidth - 18\tabcolsep) * \real{0.0886}}
  >{\raggedright\arraybackslash}p{(\linewidth - 18\tabcolsep) * \real{0.0590}}
  >{\raggedright\arraybackslash}p{(\linewidth - 18\tabcolsep) * \real{0.1771}}
  >{\raggedright\arraybackslash}p{(\linewidth - 18\tabcolsep) * \real{0.2325}}@{}}
\toprule\noalign{}
...
\begin{tcolorbox}[enhanced jigsaw, opacityback=0, colframe=quarto-callout-note-color-frame, colback=white, rightrule=.15mm, breakable, left=2mm, arc=.35mm, leftrule=.75mm, toprule=.15mm, bottomrule=.15mm]
\begin{minipage}[t]{5.5mm}
...
An umbrella-crowned ``Champion'' Elm, protected with a wire enclosure
...
Mead's Quarry is famous for its pink-hued ``Tennessee Marble.'' This
marble is in facta type of limestone prized for its beauty and
durability. This rock has been used in significant historical buildings,
including the National Gallery of Art in Washington, D.C.
...
\vspace{-3mm}\textbf{Eastern Copperhead}\vspace{3mm}
...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, colbacktitle=quarto-callout-note-color!10!white, left=2mm, coltitle=black, opacityback=0, colframe=quarto-callout-note-color-frame, colback=white, rightrule=.15mm, breakable, toptitle=1mm, bottomtitle=1mm, toprule=.15mm, title={Note}, opacitybacktitle=0.6, leftrule=.75mm, titlerule=0mm, bottomrule=.15mm]
