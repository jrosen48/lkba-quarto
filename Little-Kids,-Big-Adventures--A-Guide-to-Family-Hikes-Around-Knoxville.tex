...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, opacityback=0, colback=white, colframe=quarto-callout-warning-color-frame, breakable, toprule=.15mm, rightrule=.15mm, bottomrule=.15mm, leftrule=.75mm, left=2mm]
...
\subsection{How This Book is
Organized}\label{how-this-book-is-organized}
...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, opacityback=0, colback=white, colframe=quarto-callout-note-color-frame, breakable, toprule=.15mm, rightrule=.15mm, bottomrule=.15mm, leftrule=.75mm, left=2mm]
\begin{minipage}[t]{5.5mm}
