...
::: callout-warning
**Check Before You Go:** Trail access and conditions can change rapidly due to weather, maintenance, or seasonal closures, and --- especially for the Great Smoky Mountains National Park --- the federal funding circumstances! 
...
- Review recent weather forecasts and trail reports for hazards (e.g., fallen trees, flooding).
:::

### Trail Maps and Photos

Each hike has a *trail maps*. These should be pretty straightforward to use. Trailheads---the starting points for the hikes---are marked with a green dot, and the trail is in red, with key features of the trail noted along the way. We also include one or more photos for each hike; we tried to select these to show what makes the hike unique.
