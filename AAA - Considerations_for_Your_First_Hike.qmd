...
There's a little secret in the hiking world. You don't need a lot to get started. Indeed, may not need anything _new_ at all.
...
Hiking can be different from other physical activities in that it is not a competition. Instead, it is about experiencing the outdoors in our own way. 

This applies to beginners and to the most experienced hikers; a common saying shared among long-distance hikers is to *hike your own hike.* This means that each person hiking will hike in their way, and that there is not anything like a correct way to lace up your shoes and to get outdoors with your family. If this applies to long-distance hikers, we think it doubly applies to families hiking with littles! Hike your own hike.
...
One of the benefits of living close to great hiking opportunities is that we can be a little choosy about when and where we hike. While we are card carrying members of the puddle splashing club, we also appreciate that our littles may have a better time when it is not 50 &deg;F and rainy. Does it look like it is going to rain all day, border on being too cold, or be oppressively hot? You can choose another day to hike; we have enough good weather that we can avoid the less-than-ideal days. 

![Photo credit to Katie and Joshua Rosenberg](img/trees-with-light.jpeg)
...
When taking on a lengthier hike or traveling farther from home, the following can be helpful:

-   A change of clothes, including socks
-   A jacket or additional layers for warmth
-   A first aid kit

We didn't list shoes; we firmly believe that hiking shoes are _not_ necessary, though they can be helpful on some trails. Shoes with some traction can help, particularly if the trail is rocky, but we don't think these are needed at the outset.

The appendix has some recommendations for a basic first-aid kit as well as recommendations for some additional items you may optionally wish to bring.
